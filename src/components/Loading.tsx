      ...
      */}
      ...
      >
        <motion.div
          ...
          className="w-full h-full bg-[radial-gradient(circle_at_center,_transparent_40%,_rgba(60,5,5,0.7)_100%)]"
        />
      </motion.div>
      ...
      >
        ...
        */}
        <div className="relative w-full max-w-[320px] sm:max-w-[400px] md:max-w-[480px] aspect-[3/4]">
          ...
          {/* Artist Image with subtle float effect */}
          <motion.div 
            initial={{ opacity: 0 }}
          ...
          <div className="absolute top-[18%] sm:top-[20%] left-[80%] sm:left-[90%] md:left-[100%] flex items-center min-w-[200px] z-10">
            <span className="block w-2 sm:w-2.5 h-2 sm:h-2.5 bg-white rounded-full mr-3 shrink-0" />
