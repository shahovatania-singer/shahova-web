...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative flex flex-col items-center justify-center w-full z-10 pt-32 pb-20 min-h-screen"
    >
      ...
      <div className="mb-auto w-full flex flex-col items-center">
        <Carousel />
        <p className="text-xs font-semibold tracking-[0.15em] text-gray-300 uppercase -mt-4 text-center relative z-30">
