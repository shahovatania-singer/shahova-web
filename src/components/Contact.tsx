...
export default function Contact() {
  return (
    <section id="contact" className="relative w-full z-10 py-24 px-8 max-w-[1440px] mx-auto flex flex-col mb-20">
      {/* Top Label */}
      <div className="mb-6">
      ...
      <div className="flex flex-row flex-wrap items-center justify-center gap-10 md:gap-16 py-10">
        ...
        >
          ...
          <span className="text-xl md:text-2xl font-semibold uppercase tracking-wider">Telegram</span>
        </a>

        {/* WhatsApp */}
        <a 
          href="https://wa.me/972509324792" 
          target="_blank" 
          rel="noopener noreferrer"
          className="group flex items-center gap-4 text-white hover:text-red-600 transition-colors duration-300"
          aria-label="WhatsApp"
        >
          ...
          <span className="text-xl md:text-2xl font-semibold uppercase tracking-wider">WhatsApp</span>
        </a>

        {/* Email */}
        <a 
          href="mailto:shahova.tania20@gmail.com" 
          className="group flex items-center gap-4 text-white hover:text-red-600 transition-colors duration-300"
          aria-label="Email"
        >
