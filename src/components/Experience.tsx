...
export default function Experience() {
  return (
    <section id="experience" className="relative w-full z-10 py-24 px-8 max-w-[1440px] mx-auto flex flex-col mb-20">
      {/* Top Label */}
      <div className="mb-6">
      ...
      <div className="flex flex-col lg:flex-row gap-20 lg:gap-32 items-center lg:items-start w-full">
        ...
        <div className="relative w-full md:w-[80%] lg:w-[55%] flex-shrink-0">
          {/* Third Layer */}
        ...
        {/* Right Column - List */}
        <div className="w-full lg:w-[45%] flex flex-col justify-center gap-14 mt-8 lg:mt-0">
          {/* Item 1 */}
          <div className="flex flex-col gap-4">
            <span className="text-red-600 font-black tracking-widest text-lg">
              01
            </span>
            <p className="text-sm md:text-base lg:text-sm xl:text-base text-gray-200 font-medium tracking-[0.08em] uppercase leading-relaxed max-w-md">
              BRINGING BOLD IDEAS TO LIFE THROUGH STYLE AND CONTENT.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm md:text-base lg:text-sm xl:text-base text-gray-200 font-medium tracking-[0.08em] uppercase leading-relaxed max-w-md">
              ELEVATING PRODUCTION QUALITY WITH CUTTING-EDGE TECHNOLOGY.
            </p>
          </div>
